...
int main()
{
    ...
    while(seguir=='s')
    {
     // mostrarPersonas(listaPropetarios,tamPropetarios);
        ...
        printf("11-  Ordenar Segun Criterio\n");
        printf("12-  Pedir edad segun criterio \n ");
        printf("13-  Salir\n");
        ...
        case 10:
            ...
            break;
        case 11:
          pedirMensaje("ingrese en que orden quiere ordenar\n 1-Ascendente\n 2-Descendente",auxiliar);
          validar_numero(auxiliar);
          ordenar=atoi(auxiliar);
          switch(ordenar)
     {

     case 1:
        ordenarAscendente(listaPropetarios,tamPropetarios);
            getch();
            break;
     case 2:
        ordenarDescendiente(listaPropetarios,tamPropetarios);
        getch();
        break;
            }
            break;
     case 12:
        pedirEdad(listaPropetarios,tamPropetarios);
        getch();
        break;
        case 13:
            seguir = 'n';
