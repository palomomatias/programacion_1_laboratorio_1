...
#define TAM 3
/*
crear .h , crear estructura ahi defino subconjuntos de elementos puede tener un array se accede a traves de .algo


traer menu para el parcial
*/
